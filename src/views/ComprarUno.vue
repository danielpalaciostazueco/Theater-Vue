        ...
        <section class="horarios" v-if="obra && obra.Imagenes && obra.Imagenes.length > 0">
          ...
          <div class="horarios-txt">
            ...
            <ul class="horarios-txt__list">
              <li v-for="fecha in obra.Fechas" :key="fecha" class="horarios-txt__item">
                {{ fecha }}
                <RouterLink :to="{ name: 'comprarEntrada', params: { obraId: obra.ObraId, fecha: fecha }}" class="button-bought__link">Comprar</RouterLink>
              </li>
            </ul>
          </div>
        </section>
