    ...
    <div id="container" class="information-container">
        ...
        <div class="container-frame" v-if="store.storeObras.length > 0">
            ...
            <div class="asientos-disponibles">
                <h3> {{ $t("Comprar1.session1") }} {{ asientos - asientosOcupados.sesion1 }} {{ $t("Comprar1.text3") }}
                </h3>
                <h3> {{ $t("Comprar1.session2") }} {{ asientos - asientosOcupados.sesion2 }} {{ $t("Comprar1.text3") }}
                </h3>
                <h3> {{ $t("Comprar1.session3") }} {{ asientos - asientosOcupados.sesion3 }} {{ $t("Comprar1.text3") }}
                </h3>
            </div>
        </div>
    </div>
